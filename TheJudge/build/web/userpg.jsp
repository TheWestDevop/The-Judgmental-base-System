<%-- 
    Document   : userpg
    Created on : May 21, 2018, 11:16:46 AM
    Author     : user
--%>
...
<%@page session="true" %>
<%
        loadlawyers lawyer =  new loadlawyers();
        
    %>
<!DOCTYPE html>
<html ng-app="UserHome" >
    <head>
...
<div>&nbsp;</div>
    <div align="center"><%=(session.getAttribute("notify"))%></div>
         <br> 
   <div  align="center" style="color:blanchedalmond; text-shadow:5px 5px 10px black;"><h2><b>LIST OF LAWYER AVALIABLE<b></h2></div>
                   <br>
                   <div class="main">
       <div class="align-center" align="center" style="font-weight: bolder; font-size:15px;">
<%=(lawyer.getName())%>
...
<script src="userprop/app.js"></script>
<script src="userprop/Mover.js"></script>  
