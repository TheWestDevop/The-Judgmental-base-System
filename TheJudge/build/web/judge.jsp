  ...
  <div>
      <div  align="center" style="color:white; text-shadow:5px 5px 10px black;"><h1><b>CLIENT REGISTRATION FORM<b></h1></div>
            ...
            <div class="g-container--md g-padding-y-80--xs g-padding-y-125--sm">
                ...
                <form action="Paystack" method="post" class="center-block g-width-500--sm g-width-550--md">
                    

                     
                     <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                            <input type="text"  required name="surname" class="form-control s-form-v3__input" placeholder="Surname" ng-model="surname" min-length="1"  required>
                           
                        </div>
                        <div class="col-sm-6">
                            <input type="text" name="othername" required class="form-control s-form-v3__input" placeholder="Other Names" ng-model="othername" required>
                        </div>
                    </div> 
                        <br>
                    <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                             <select  required class="form-control s-form-v3__input"  name="sex" required>
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="birthplace"  required class="form-control s-form-v3__input" placeholder="Place of birth" required>
                        </div>
                    </div>
                        <br>
                       <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                            <select  required class="form-control s-form-v3__input"  name="mstatus" required>
                        ...
                        <div class="col-sm-6">
                                 ...
                                 <select required="" style="font-weight:bold;width:auto; max-width:300px" class="form-control s-form-v3__input"  name="stateorigin" required="true">
...
<%= resultset.getString("state")%> </option>
 <%}}catch(Exception ex){ex.printStackTrace();out.println("Error " + ex.getMessage());}%>
                       ...
                       <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                               <input type="text" required  style="background-color: transparent" name="country" value="Nigeria" class="form-control s-form-v3__input" placeholder="Nigeria" readonly>
                      
                        </div>
                        <div class="col-sm-6">
                             <select required="" style="font-weight:bold; width:auto; max-width:230px"  class="form-control s-form-v3__input"  name="lga" >
...
<%= resultset.getString("lga")%> </option>
 <%}}catch(Exception ex){ex.printStackTrace();out.println("Error " + ex.getMessage());}%>
                        ...
                        <br>
                            <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                           <input type="text" name="spouse" class="form-control s-form-v3__input" placeholder="Name of Spouse" >
                      
                        </div>
                        <div class="col-sm-6">
                            <input type="number" name="numchildren" class="form-control s-form-v3__input" min="0" placeholder="Number of Children" >
                        </div>
                    </div>
                        <br>
                            <div class="row g-row-col-5 g-margin-b-50--xs">
                             <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                        <input type="text" name="eduQualification" class="form-control s-form-v3__input" placeholder="Current Education Qualification" >
                             </div>
                                <div class="col-sm-6">
                                    <input type="number" name="age" class="form-control s-form-v3__input" min="20" max="100" placeholder="Age" required>
                                </div>
                            </div>
                         <br>
                       <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                           <input type="text" name="occupation" class="form-control s-form-v3__input" placeholder="Occupation" required>
                      
                        </div>
                        <div class="col-sm-6">
                            <input type="text" name="natureofwork" class="form-control s-form-v3__input" placeholder="Nature of Work/Business" required>
                        </div>
                    </div>     
                         <br>   
                       <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                           <input type="text" name="religion" class="form-control s-form-v3__input" placeholder="Religion" required>
                      
                        </div>
                        <div class="col-sm-6">
                            <input type="text" name="address" class="form-control s-form-v3__input" placeholder="Official Address" required>
                        </div>
                    </div>    
                          <br> 
                        <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                           <input type="number" name="contact" class="form-control s-form-v3__input" placeholder="Official Contact" required>
                    ...
                    <div class="g-margin-b-80--xs">
                        <textarea class="form-control s-form-v3__input" name="Clientbrief" rows="5" placeholder="CLIENT BRIEF / INSTRUCTION" required></textarea>
                    </div>
                    <br><br>
        ...
        <br>
        <div>I,&nbsp;<h4><b>{{surname}}&nbsp;&nbsp;{{othername}}&nbsp;&nbsp;</b></h4>do hereby declare that all information hereinabove supplied 
         ...
         <input type="checkbox" name="agree" value="term" required />&nbsp;I agree to the <a class="link" data-toggle="modal" href="#myModal">Terms and Conditions</a>
         <br>
         <br>
         
         <br>  
           <br>
           <button type="submit" class="btn btn-block bg-primary "><a>
                  <span style="color:white; font-size: 40px;" class="glyphicon glyphicon-log-in"></span></a></button>
