 <%-- 
    Document   : Client
    Created on : Apr 24, 2018, 12:55:39 PM
    Author     : user
--%>
...
<div class="container">
  ...
  <div>
      <div  align="center" style="color:white; text-shadow:5px 5px 10px black;"><h1><b>LAWYER SUBSCRIPTION FORM<b></h1></div>
          
               <div class="g-position--relative g-bg-color--primary">
            <div class="g-container--md g-padding-y-80--xs g-padding-y-125--sm">
                               
             
                <form name="lawyer" ACTION="Move" METHOD="post"    class="center-block g-width-500--sm g-width-550--md">
                    

                     
                     <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                            <input type="text"  required name="Sname" class="form-control s-form-v3__input" placeholder="Surname" ng-model="surname" min-length="1"  required>
                           
                        </div>
                        <div class="col-sm-6">
                            <input type="text" name="Oname" required class="form-control s-form-v3__input" placeholder="Other Names" ng-model="othername" required>
                        </div>
                    </div> 
                        <br>
                    <div class="row g-row-col-5 g-margin-b-50--xs">
                       ...
                       <div class="row g-row-col-5 g-margin-b-50--xs">
                        ...
                        <div class="col-sm-6">
                                 ...
                                 <select required  style="font-weight:bold;width:auto; max-width:300px" class="form-control s-form-v3__input"  name="stateorigin" required>
...
<%= resultset.getString("state")%> </option>
 <%}}catch(Exception ex){ex.printStackTrace();out.println("Error " + ex.getMessage());}%>
                       ...
                       <div class="row g-row-col-5 g-margin-b-50--xs">
                        ...
                        <div class="col-sm-6">
                             <select style="font-weight:bold; width:auto; max-width:230px" required class="form-control s-form-v3__input"  name="lga" required>
...
<%= resultset.getString("lga")%> </option>
 ...
 %>
                        ...
                        <br>
                            <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                           <input type="text" name="spouse" class="form-control s-form-v3__input" placeholder="Name of Spouse" required>
                      
                        </div>
                        <div class="col-sm-6">
                            <input type="number" name="numchild" class="form-control s-form-v3__input" min="0" placeholder="Number of Children" required>
                        </div>
                    </div>
                        <br>
                            <div class="row g-row-col-5 g-margin-b-50--xs">
                             <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                        <input type="text" name="edu" class="form-control s-form-v3__input" placeholder="Current Education Qualification" required>
                             </div>
                                <div class="col-sm-6">
                       ...
                       <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                           <input type="number" name="casewon" class="form-control s-form-v3__input" placeholder="Number Of Case  Won" min="0"  required>
                      
                        </div>
                        <div class="col-sm-6">
                            <input type="number"min="0"  name="casegiven" class="form-control s-form-v3__input" placeholder="Number Of Case Given" required>
                        </div>
                    </div>     
                         <br>   
                       <div class="row g-row-col-5 g-margin-b-50--xs">
        ...
        <div>I,&nbsp;<h4><b>{{surname}}&nbsp;&nbsp;{{othername}}&nbsp;&nbsp;</b></h4>do hereby declare that all information hereinabove supplied 
         ...
         <button type="submit" class="btn btn-block bg-primary ">
                  <span style="color:white; font-size: 15px;">Get Me Hired</span></button>
     </form>
                       <br>
                       <br>
