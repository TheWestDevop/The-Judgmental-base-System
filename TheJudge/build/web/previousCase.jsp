...
<div>&nbsp;</div>
<div class="container">
<div  align="center" style="color:blanchedalmond; text-shadow:5px 5px 10px black;"><h2><b>Previous Case<b></h2></div>
...
"FROM lawyer_cases where lawyer_id='"+session.getAttribute("mail")+"'";
   ...
   <div class="main">
       ...
       <%
        ...
        while(res.next()){
            ...
            <div class="panel panel-info" style="border-radius:10px; box-shadow: 5px 4px 42px;">
                <div class="panel-heading">&nbsp;<b><%=res.getString("Case_Title") %></b>&nbsp;</div>
      <div class="panel-body" style="color:black;background-color:#64b5f6; font-family: sans-serif; font-variant: small-caps; font-weight: bold;">

            
            <%=res.getString("Cases") %>
            <br/><br/><input type="submit" style="color:white; background-color: #ad1457; border-radius:25px;"  class="btn btn interested" value="AM INTERESTED" />
    </div>
            </form>
            </div>
            </div>
...
<div class="container">
        ...
        <footer class="bg-primary fut"> &copy;COPYRIGHT&nbsp;<script>document.write(new Date().getFullYear());</script>&nbsp;<a href="#">THE JUDGE NIGERIA</a> - All RIGHTS RESERVED.
            &nbsp;DEVELOPED BY<a href="@yourDigit" style="color:orangered; font-size:25px; font-family:The New Times,serif;">DigiT</a><a style="color:orangered; font-size:25px; font-family:The New Times,serif;">Prof International</a></footer>
</div>                 
