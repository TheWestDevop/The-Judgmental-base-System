   ...
   <div class="main">
       <div class="align-center" align="center" style="font-weight: bold;">
           <div class="container">
                ...
                <div align="center"><%=(session.getAttribute("emsg"))%></div>
         <br> 
               <div class="well-lg" style="">
            <div class="form-group">
  <textarea class="form-control" name="title" rows="25">Your Statement</textarea>
            </div><br><div class="form-group"><input type="text"  class="form-control" value="Case Title" /></div><br><a href="#!/userhome"><button class="btn btn-primary">Get A Lawyer</button></a>
               </div>
