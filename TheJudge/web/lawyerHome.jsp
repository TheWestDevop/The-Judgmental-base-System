...
<div>&nbsp;</div>
<div class="container">
<div  align="center" style="color:blanchedalmond; text-shadow:5px 5px 10px black;"><h2><b>NEW CASE'S<b></h2></div>
                   <br>
                                 <%          
   Connection con = null;
   ...
   ResultSet res = null;
         ...
         String data = "SELECT DISTINCT User_Case,User_Case_Title\n" +
"FROM cases\n";
       ...
       <%
        ...
        while(res.next()){
            ...
            <div class="panel panel-info" style="border-radius:10px; box-shadow: 5px 4px 42px;">
                <div class="panel-heading">&nbsp;<b><%=res.getString("User_Case_Title") %></b>&nbsp;</div>
