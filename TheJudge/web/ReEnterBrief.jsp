...
<div>&nbsp;&nbsp;&nbsp;&nbsp;</div>
   ...
   <div class="main">
       <div class="align-center" align="center" style="font-weight: bold;">
           <div class="container">
               <form method="post" action="Re-Judge-Again"> 
                <div align="center"><%=(request.getAttribute("errmsg"))%></div>
         <br> 
               <div class="well-lg" style="">
            <div class="form-group">
  <textarea class="form-control" name="statement" rows="25">Your Statement</textarea>
            </div><br><br><a href="#!/userhome"><button class="btn btn-primary">Get Judgement</button></a>
               </div>
