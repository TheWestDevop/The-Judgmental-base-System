       ...
       <div class="align-center" align="center" style="font-weight: bold;">
          <div  class="container center-block" >
                ...
                <form class="form-signin" action="InsertAPI" method="POST" role="form">
                    ...
                    <h2 class="form-signin-heading">  <div  align="center" style="font-family:'Times Roman';color:blanchedalmond; text-shadow:5px 5px 10px black;"><h1><b>WRITE A NEW POST<b></h1></div> </h2>
                    <br>
                    <p><strong  style="font-weight: bold;">Title : </strong></p>
                    <input name="txtTitle" type="text" class="form-control"   required autofocus>
                    <br>
                    <p><strong style="font-weight: bold;">Description: </strong></p>
                    <input name="txtDescription" type="text" class="form-control"  required >
                    
                    <br>
                    <p><strong style="font-weight: bold;">Content : </strong></p>
                    <textarea name="txtContent" style="resize: both;" type="text" class="form-control" rows="15" cols="8" required > </textarea>
                    <br>
                    <p><strong style="font-weight: bold;">Author : </strong></p>
